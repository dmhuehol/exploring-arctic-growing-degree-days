#######################################
# Repurposed preproc_sh for processing missing member, Arctic-only, 
# with no landmask.
...
IN_PATH="/barnes-scratch/DATA/CESM2-LE/raw_data/daily/TREFHT/vault/" # ASHA
...
RED_PATH="/barnes-scratch/DATA/CESM2-LE/temp/refined_nomask/vault/" # ASHA
