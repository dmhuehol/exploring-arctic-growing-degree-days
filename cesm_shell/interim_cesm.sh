#######################################
# interim_cesm
# Reprocess data from merged files for CESM TREFHT netCDF files. 
# Designed for LENS2.
# Split from preproc_cesm for ease of use.
...
IN_PATH="/barnes-scratch/DATA/CESM2-LE/raw_data/daily/TREFHT/" # ASHA
...
for me in ${ENS_UNQ[@]}; do
    ...
    cdo -L -setattribute,$SEL_VAR@units="degC" -subc,273.15 -sellonlatbox,0,360,50,90 -selvar,$SEL_VAR $TEMP_NAME $OUT_ARC
