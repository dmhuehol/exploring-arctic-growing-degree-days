...
setp_sst = cg.SetParams(
    dims=['time', 'realization'], mask_flag=None, rlz='all', yrs=[1850, 1859],
    yrs_rel_to=[1850, 1859], z_flag=True)
gp_gdd = cg.GuideParams(guide_by='mean', composite_key='min10', qoi=0.25)
cmn_path = '/Users/danielhueholt/Documents/Figures/arc-gdd_fig/'
cmn_path += '20260202_composite-crossover/6_min10_gdd_' + bmb_type + '-19902015/'
...
puppets.paired_composites_ts(
    ...
    setp_composite=setp_sst, dp_guide_alltimes=dp_gdd_roi_alltimes, ip=ip,
